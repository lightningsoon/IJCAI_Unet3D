...
class fitter():
    ...
    def set_model(self):
        ...
        self.m.compile(optimizer=Adam(0.0004),
...
def train():
    ...
    h = myfitter.m.fit_generator(
        ...
        steps_per_epoch=train_times_each_data * train_data.files_number // batch_size // myfitter.gpu_nums // epoch_scale_factor,
        ...
        validation_steps=val_times_each_data * val_data.files_number // batch_size // myfitter.gpu_nums,
